...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Vendor CSS Files -->
        <link
            href="{{ asset('arsha/assets/vendor/aos/aos.css') }}"
            rel="stylesheet"
        />
        <link
            href="{{
        ...
        <link
            href="{{
                asset('arsha/assets/vendor/bootstrap-icons/bootstrap-icons.css')
            }}"
            rel="stylesheet"
        />
        <link
            href="{{
                asset('arsha/assets/vendor/boxicons/css/boxicons.min.css')
            }}"
            rel="stylesheet"
        />
        <link
            href="{{
                asset('arsha/assets/vendor/glightbox/css/glightbox.min.css')
            }}"
            rel="stylesheet"
        />
        <link
            href="{{ asset('arsha/assets/vendor/remixicon/remixicon.css') }}"
            rel="stylesheet"
        />
        <link
            href="{{
                asset('arsha/assets/vendor/swiper/swiper-bundle.min.css')
            }}"
            rel="stylesheet"
        />
        ...
        <link
            href="{{ asset('arsha/assets/css/style.css') }}"
            rel="stylesheet"
        />
  ...
  * License: https://bootstrapmade.com/license/
  ======================================================== -->
    ...
    <body>
        ...
        <header id="header" class="fixed-top">
            <div class="container d-flex align-items-center">
                <h1 class="logo me-auto">
                    <a href="index.html"
                        >Ma<span class="text-info">ma</span>nin</a
                    >
                </h1>
                    ...
                    >
                        ...
                        >
                            ...
                            <a
                                ...
                                ><span>Lihat Video</span></a
                            >
                        </div>
                    </div>
                    <div
                        class="col-lg-6 order-1 order-lg-2 hero-img text-center"
                        data-aos="zoom-in"
                        data-aos-delay="200"
                    >
                        <img
                            src="{{ asset('arsha/assets/img/hero_img.png') }}"
                ...
                <div class="container" data-aos="zoom-in">
                    <div class="row">
                        <div class="col-lg-9 text-center text-lg-start">
                            ...
                            <p>
                                Apabila anda ingin melakukan konsultasi seputar masakan dan kuliner, jangan sungkan untuk menghubungi kami.
                            </p>
                        </div>
            ...
            <section id="portfolio" class="portfolio">
                <div class="container" data-aos="fade-up">
                    ...
                    >
                        ...
                        <li data-filter=".filter-app">Makanan Ringan</li>
                        <li data-filter=".filter-card">Aneka Sambal</li>
                        <li data-filter=".filter-web">Sayuran</li>
                    </ul>
                    ...
                    >
                        ...
                        >
                            <div class="portfolio-img">
                                <img
                                    src="{{ asset('arsha/assets/img/portfolio/masakan1.jpeg') }}"
                                    class="img-fluid"
                                    alt=""
                                />
                            </div>
                        ...
                        >
                            <div class="portfolio-img">
                                <img
                                    src="{{ asset('arsha/assets/img/portfolio/masakan2.jpeg') }}"
                                    class="img-fluid"
                                    alt=""
                                />
                            </div>
                            <div class="portfolio-info">
                                ...
                                <p>Web</p>
                                <a
                                    href="{{ asset('arsha/assets/img/portfolio/masakan2.jpeg') }}"
                                    data-gallery="portfolioGallery"
                                    class="portfolio-lightbox preview-link"
                                    title="Web 3"
                                    ><i class="bx bx-plus"></i
                        ...
                        >
                            <div class="portfolio-img">
                                <img
                                    src="{{ asset('arsha/assets/img/portfolio/masakan3.jpeg') }}"
                                    class="img-fluid"
                                    alt=""
                                />
                            </div>
                            <div class="portfolio-info">
                                ...
                                <p>App</p>
                                <a
                                    href="{{ asset('arsha/assets/img/portfolio/masakan3.jpeg') }}"
                                    data-gallery="portfolioGallery"
                                    class="portfolio-lightbox preview-link"
                                    title="App 2"
                                    ><i class="bx bx-plus"></i
                        ...
                        >
                            ...
                            <div class="portfolio-info">
                                ...
                                <p>Web</p>
                                <a
                                    href="{{ asset('arsha/assets/img/portfolio/masakan1.jpeg') }}"
                                    data-gallery="portfolioGallery"
                                    class="portfolio-lightbox preview-link"
                                    title="Web 2"
                                    ><i class="bx bx-plus"></i
                    ...
                    <div class="row">
                        ...
                        >
                            <div class="member d-flex align-items-start">
                                <div class="pic">
                                    <img
                                        src="{{ asset('arsha/assets/img/team/team-1.jpg') }}"
                                        class="img-fluid"
                                        alt=""
                                    />
                                </div>
                        ...
                        >
                            <div class="member d-flex align-items-start">
                                <div class="pic">
                                    <img
                                        src="{{ asset('arsha/assets/img/team/team-2.jpg') }}"
                                        class="img-fluid"
                                        alt=""
                                    />
                                </div>
                        ...
                        >
                            <div class="member d-flex align-items-start">
                                <div class="pic">
                                    <img
                                        src="{{ asset('arsha/assets/img/team/team-3.jpg') }}"
                                        class="img-fluid"
                                        alt=""
                                    />
                                </div>
                        ...
                        >
                            <div class="member d-flex align-items-start">
                                <div class="pic">
                                    <img
                                        src="{{ asset('arsha/assets/img/team/team-4.jpg') }}"
                                        class="img-fluid"
                                        alt=""
                                    />
                                </div>
        ...
        <script src="{{
                asset(
                    'arsha/assets/vendor/bootstrap/js/bootstrap.bundle.min.js'
                )
            }}"></script>
        <script src="{{
                asset('arsha/assets/vendor/glightbox/js/glightbox.min.js')
            }}"></script>
        <script src="{{
                asset('arsha/assets/vendor/isotope-layout/isotope.pkgd.min.js')
            }}"></script>
        <script src="{{
                asset('arsha/assets/vendor/swiper/swiper-bundle.min.js')
            }}"></script>
        <script src="{{
                asset('arsha/assets/vendor/waypoints/noframework.waypoints.js')
            }}"></script>
        <script src="{{
                asset('arsha/assets/vendor/php-email-form/validate.js')
            }}"></script>
